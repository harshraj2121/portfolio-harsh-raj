    ...
    <div className='w-full h-25 flex items-center text-white justify-between px-16 relative'>
        <div className='font-press tracking-tighter cursor-pointer h-[50%] w-40 flex'>
          ...
          <div className=' relative w-2/3 h-full text-[11px] flex flex-col justify-center overflow-hidden'>
            ...
            <motion.span initial={{ transform: "translateX(-100px)"}} animate={{transform: "translateX(0px)", }} transition={{duration: .5, delay: 2.5}} className='pl-2'>Harsh Raj</motion.span>
            <motion.span initial={{ transform: "translateX(-100px)"}} animate={{transform: "translateX(0px)", }} transition={{duration: .5, delay: 2.5}} className='pl-2'>Developer</motion.span>
          </div>
        </div>
        <motion.div initial={{opacity: 0, transform: "translateY(-40px)"}} animate={{opacity: 1, transform:"translateY(0px)"}} transition={{duration: .5, delay: 3}} className='flex items-center jsutify-center gap-10 text-zinc-200 bg-[#0C0C0C] tracking-wide border border-t-0 border-zinc-600 rounded py-3 px-6'>
