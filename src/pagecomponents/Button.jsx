...
function Button({title = "Start a Project"}) {
  return (
    <div className='group link w-44 h-10 px-4 py-2 bg-[#E8602E] cursor-pointer rounded-md overflow-hidden flex items-center justify-between hover:shadow-[0_0_45px_5px_#E8602E] transition-all duration-300'>
